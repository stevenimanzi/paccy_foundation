    ...
    <main>
      ...
      <header className="site-header">
        ...
        <nav aria-label="Main navigation">
          <a href="/about">About</a><a href="/programs">Programs</a><a href="/get-involved">Get involved</a>
        </nav>
      ...
      <footer><div className="footer-brand"><img src="/images/paccy_faundation_logo.png" alt="" /><p><strong>Paccy Foundation</strong><br />Every child deserves a chance to learn.</p></div><div><h3>Explore</h3><a href="#about">About us</a><a href="#programs">Our programs</a><a href="#impact">Impact & transparency</a><a href="#help">Get involved</a></div><div><h3>Contact</h3><a href="mailto:hello@paccyfoundation.org">hello@paccyfoundation.org</a><span>Kigali, Rwanda</span><a href="https://wa.me/" rel="noreferrer">WhatsApp ↗</a></div><div><h3>Follow</h3><a href="#">Instagram</a><a href="#">Facebook</a><a href="#">LinkedIn</a></div><p className="copyright">© 2026 Paccy Foundation · Privacy · Child safeguarding</p></footer>
    </main>
  );
}
